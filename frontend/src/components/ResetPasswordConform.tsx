        ...
        <div className="overflow-x-hidden w-full min-h-screen flex text-white bg-zinc-950 font-sans relative items-center justify-center">
            ...
            <div className="w-full max-w-md p-8 sm:p-12 bg-zinc-950 border border-zinc-900 rounded-xl shadow-2xl z-10 relative">
                <div className="text-center sm:text-left mb-8">
                    <h2 className="text-3xl font-bold tracking-tight text-white mb-2">Change Password</h2>
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4 p-4 border border-zinc-800 rounded-lg bg-zinc-900/30">
                        <div className="space-y-2">
                            ...
                            <input 
                                ...
                                className="w-full px-4 py-2.5 bg-zinc-900/50 backdrop-blur border border-zinc-800 rounded-md focus:outline-none focus:ring-1 focus:ring-[#E50914] transition-colors text-white disabled:opacity-50"
                            />
                        </div>
                        <div className="flex space-x-3">
                            <button
                                ...
                                className="flex-1 py-2 bg-white text-black font-semibold rounded-md transition-colors hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                            ...
                            <button
                                ...
                                disabled={isOtpVerified}
                                className="px-4 py-2 bg-transparent border border-zinc-700 text-white font-medium rounded-md transition-colors hover:bg-zinc-800 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                Resend
                            </button>
                        </div>
                    ...
                    <form onSubmit={handlePassword} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <input 
                                    ...
                                    placeholder="••••••••"
                                    disabled={!isOtpVerified}
                                    className="w-full px-4 py-2.5 pr-10 bg-zinc-900/50 backdrop-blur border border-zinc-800 rounded-md focus:outline-none focus:ring-1 focus:ring-[#E50914] transition-colors text-white disabled:opacity-50"
                                />
                                <button 
                                    type="button" 
                        ...
                        <Link to="/loginPage" className="w-full flex items-center justify-center text-sm py-2.5 mt-2 bg-transparent border border-zinc-800 hover:bg-zinc-900 text-white font-semibold rounded-md transition-colors">
                            Cancel
                        </Link>
                    </form>
                </div>
