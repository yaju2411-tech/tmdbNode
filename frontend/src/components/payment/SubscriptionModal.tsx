...
export const SubscriptionModal: React.FC<Props> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/70 backdrop-blur-md p-3 sm:p-4 animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl max-h-[90vh] sm:max-h-[85vh] bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden flex flex-col transition-colors my-auto">
        {/* Top Header */}
        <div className="flex items-center justify-between px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-200 dark:border-zinc-800 bg-gradient-to-r from-red-50 dark:from-red-950/40 via-gray-50 dark:via-zinc-900 to-white dark:to-zinc-950 shrink-0">
          <div className="flex items-center gap-3">
            <div className="p-2 sm:p-2.5 bg-red-500/10 text-red-600 dark:text-red-500 rounded-2xl border border-red-500/20">
        ...
        <div className="overflow-y-auto flex-1 min-h-0 p-4 sm:p-6 bg-gray-50 dark:bg-zinc-950 space-y-4">
          {/* ACTIVE VIP BANNER */}
          {isVipActive && (
            <div className="bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-500/30 px-4 py-3.5 rounded-2xl flex items-center justify-between gap-4">
              ...
              <span className="text-[10px] bg-emerald-500/20 text-emerald-800 dark:text-emerald-300 px-2.5 py-0.5 rounded-full font-bold uppercase shrink-0">
                ACTIVE
              </span>
            </div>
          )}
        ...
        {/* Footer Action */}
        <div className="p-4 sm:p-6 bg-white dark:bg-zinc-900/80 border-t border-gray-200 dark:border-zinc-800 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 shrink-0">
